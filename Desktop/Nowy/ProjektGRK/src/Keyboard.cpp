...
void keyboardPressed(unsigned char key, int x, int y)
{
	...
	case 'q':
	case 'Q':
		keyStatus[SIM_KEY_STATUS_YAW_LEFT] = true; break; 

	case 'e':
	case 'E':
		keyStatus[SIM_KEY_STATUS_YAW_RIGHT] = true; break;
...
void keyboardUp(unsigned char key, int x, int y)
{
	...
	case 'q':
	case 'Q':
		keyStatus[SIM_KEY_STATUS_YAW_LEFT] = false; break; 

	case 'e':
	case 'E':
		keyStatus[SIM_KEY_STATUS_YAW_RIGHT] = false; break;
...
void keyboardSpecialUp(int key, int x, int y)
{
	...
	case GLUT_KEY_UP:
		keyStatus[SIM_KEY_STATUS_PITCH_LEFT] = false; break;

	case GLUT_KEY_DOWN:
		keyStatus[SIM_KEY_STATUS_PITCH_RIGHT] = false; break;

	case GLUT_KEY_LEFT:
		keyStatus[SIM_KEY_STATUS_ROLL_LEFT] = false; break; 

	case GLUT_KEY_RIGHT:
		keyStatus[SIM_KEY_STATUS_ROLL_RIGHT] = false; break; 
